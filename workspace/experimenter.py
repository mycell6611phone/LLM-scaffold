...
class Experimenter:
    ...
    Notes:
     - Keep deterministic execution and evaluation when implemented.
     - No I/O or persistence in this scaffold.
    """

    def __init__(self, *, namespace: str = "default", policy: Optional[Dict[str, Any]] = None):
